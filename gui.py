...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.layout_plot_1.setContentsMargins(-1, -1, -1, 11)
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget_plot_2)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.layout_plot_2 = QtWidgets.QVBoxLayout()
        self.layout_plot_2.setObjectName("layout_plot_2")
        self.verticalLayout_3.addLayout(self.layout_plot_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(_translate("Dialog", "Нажмите на кнопку"))
